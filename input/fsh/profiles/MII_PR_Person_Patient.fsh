...
* link MS
* insert Translation(address[Postfach] ^short, de-DE, Verweis)
* insert Translation(address[Postfach] ^short, en-US, Link)
* insert Translation(address[Postfach] ^definition, de-DE, Verweis auf eine andere Patientenressource\, die die gleiche tatsächliche Person betrifft)
* insert Translation(address[Postfach] ^definition, en-US, Link to another patient resource that concerns the same actual person)
