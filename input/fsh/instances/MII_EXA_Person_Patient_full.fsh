...
* address[Strassenanschrift].line = "Anna-Louisa-Karsch Str. 2"
* address[Strassenanschrift].city = "Berlin"
* address[Strassenanschrift].city.extension.url = "http://fhir.de/StructureDefinition/destatis/ags"
* address[Strassenanschrift].city.extension.valueCoding = $ags#11000000
* address[Strassenanschrift].state = "DE-BE"
* address[Strassenanschrift].postalCode = "10178"
* address[Strassenanschrift].country = "DE"
* address[Strassenanschrift].country.extension[countryCode].valueCoding = $iso-3166#DE "Germany"
