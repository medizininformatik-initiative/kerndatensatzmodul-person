...
| Binding | ([required](http://hl7.org/fhir/terminologies.html#required)) {{pagelink:implementation-guides/ImplementationGuide-1.x/TechnischeImplementierung/VitalstatusObservation-1.x.md, text:Observation.code}}|
